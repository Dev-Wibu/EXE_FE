...
export { createBrowserDetector, detectUrl } from "./engines/browser/detect-url.mjs";
export { detectText, extractCSSinJS, extractStyleBlocks } from "./engines/regex/detect-text.mjs";
