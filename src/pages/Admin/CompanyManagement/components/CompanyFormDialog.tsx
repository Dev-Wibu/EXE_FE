...
export function CompanyFormDialog({
  ...
  const handleLogoChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    onFormChange({ ...formData, logo: file });
  };
  ...
  const handleBannerChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    onFormChange({ ...formData, banner: file });
  };
  ...
  const handleClearLogo = () => {
    ...
    setLogoPreview(null);
    onFormChange({ ...formData, logo: undefined });
  };
  ...
  const handleClearBanner = () => {
    ...
    setBannerPreview(null);
    onFormChange({ ...formData, banner: undefined });
  };
      ...
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="company-status">Trạng thái</Label>
              <Select
                value={formData.status || "ACTIVE"}
                onValueChange={(value) =>
                  onFormChange({ ...formData, status: value as CompanyStatus })
                }>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-1 flex-wrap items-center gap-2">
                      {logoPreview ? (
                        ...
                        <button
                          type="button"
                          onClick={() => openMediaPreview("Logo công ty", displayLogoUrl)}
            ...
            <div className="space-y-2">
              <Label htmlFor="company-banner">Banner công ty</Label>
              <div className="rounded-lg border bg-slate-50 p-3 dark:bg-slate-900">
                {displayBannerUrl ? (
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      {bannerPreview ? (
                        ...
                        <button
                          type="button"
                          onClick={() => openMediaPreview("Banner công ty", displayBannerUrl)}
                          className="flex items-center gap-1 bg-transparent p-0 text-xs text-blue-600 hover:underline dark:text-blue-400">
                          <span>Xem ảnh đầy đủ</span>
                          <ExternalLink className="h-3 w-3" />
                        </button>
